      ...
      <div className="container mx-auto px-4 py-6 md:py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Desktop Purchase Button - back to original position */}
        ...
        <div className="sm:hidden fixed bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-md border-t border-border">
          <Button 
            size="lg" 
            className={`
