    ...
    <footer className="bg-secondary mt-auto">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-lg font-semibold text-primary mb-4">Grim's Store</h3>
            <p className="text-muted-foreground mb-4">
              Your ultimate destination for honest product reviews and recommendations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">support@grimsstore.com</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Grim's Store. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
